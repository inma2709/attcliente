...
const menuItems = [
  ...
  { id: 3, title: 'La organización empresarial y el proceso de información', path: '/tema01', icon: '🏢' },
  { id: 4, title: 'Calidad y oportunidad en el servicio al cliente', path: '/tema04', icon: '⭐' },
  { id: 5, title: 'Ética, Valores y Atención Inclusiva', path: '/tema16', icon: '🤝' },

  // 📚 SECCIÓN 2: HABILIDADES Y DESARROLLO DEL PROFESIONAL
  { id: 6, title: 'Gestión emocional del profesional', path: '/tema10', icon: '🧘‍♀️' },
  { id: 7, title: 'Protocolo empresarial e imagen personal', path: '/tema06', icon: '👔' },
  { id: 8, title: 'Comunicación presencial y habilidades sociales', path: '/tema05', icon: '👥' },
  { id: 9, title: 'Fundamentos y flujos de la comunicación empresarial', path: '/tema02', icon: '💬' },
  ...
  { id: 14, title: 'Comunicación telefónica y gestión de centralitas', path: '/tema07', icon: '📞' },
  { id: 15, title: 'Comunicación escrita y redacción de documentos', path: '/tema08', icon: '📝' },
  { id: 16, title: 'Uso de nuevas tecnologías y canales telemáticos', path: '/tema09', icon: '💻' },
  { id: 17, title: 'Protección de datos, seguridad y confidencialidad', path: '/tema15', icon: '🔒' },

  // 📚 SECCIÓN 5: TÉCNICAS AVANZADAS DE VENTA Y NEGOCIACIÓN
  { id: 18, title: 'Técnicas de negociación con el cliente', path: '/tema19', icon: '🤝' },
  { id: 19, title: 'Técnicas de venta directa', path: '/tema20', icon: '🛒' },

  // 📚 SECCIÓN 6: GESTIÓN DE CONFLICTOS Y FIDELIZACIÓN
